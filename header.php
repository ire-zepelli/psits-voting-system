...
<body>
    <header class="flex justify-between items-center px-12 py-4 bg-[#412039]">
        <div class="flex items-center gap-8">
            <img src="imgs\ccs_logo.png" alt="CCS" class="w-[100px] h-[100px]">
            <img src="imgs\psits_logo.png" alt="PSITS" class="w-[100px] h-[100px]">
        </div>
    <nav class="flex gap-12 text-white font-semibold">
            <a href="Home" class="hover:text-yellow-400 text-xl">Home</a>
            <a href="Candidates" class="hover:text-yellow-400 text-xl">Candidates</a>
            <a href="Voting" class="hover:text-yellow-400 text-xl">Voting</a>
    </nav>
