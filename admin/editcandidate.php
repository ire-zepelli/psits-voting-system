<!-- edit Modal -->
<div id="edit_modal" class="fixed flex justify-center items-start w-screen h-screen bg-black/40 z-20 hidden">
        ...
        <form method="post">
            <div class="grid grid-cols-2 gap-4">
                <fieldset class="fieldset">
                    ...
                    <input type="text" name="edit_fname" id="edit_fname" class="input" required />
                </fieldset>
                <fieldset class="fieldset">
                    <legend class="fieldset-legend text-sm">Last Name</legend>
                    <input type="text" name="edit_lname" id="edit_lname" class="input" required />
                </fieldset>
            </div>
            <fieldset class="fieldset">
                <legend class="fieldset-legend text-sm">Manifesto</legend>
                <input type="text" name="edit_manifesto" id="edit_manifesto" class="input w-full" required />
            </fieldset>
            <fieldset class="fieldset">
